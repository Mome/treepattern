...
\begin{sidewaystable}
	...
	\begin{tabular}{l|l|l}
		...
		Second First &
		\includegraphics[width=.5\linewidth]{step_example_raw_1} &
		\includegraphics[width=.5\linewidth]{step_example_1}\\ \hline

		&
		\includegraphics[width=.5\linewidth]{step_example_raw_2} &
		\includegraphics[width=.5\linewidth]{step_example_2}\\ \hline

		&
		\includegraphics[width=.5\linewidth]{step_example_raw_3}&
		\includegraphics[width=.5\linewidth]{step_example_3}\\ \hline

		&
		\includegraphics[width=.5\linewidth]{step_example_raw_4}&
		\includegraphics[width=.5\linewidth]{step_example_4}\\ \hline
	\end{tabular}
\end{sidewaystable}
