...
Applied to the sentence: "Snakes such as pythons, cobras, and boas are reptiles."
, this rule results in the three edges: pythons $\rightarrow$ snakes, cobras $\rightarrow$ snakes, and boas $\rightarrow$ snakes.
